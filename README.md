...
<details>
  ...
  - Use o comando: `git clone https://github.com/tryber/sd-015-a-project-car-shop.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-015-a-project-car-shop`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-015-a-project-car-shop/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-015-a-project-car-shop/pulls) e confira que o seu _Pull Request_ está criado
